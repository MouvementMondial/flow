...
class MultiAgentIntersectionEnv_sharedPolicy_4veh_constTeamspirit(MultiEnv):
    ...
    def compute_reward(self, rl_actions, **kwargs):
        ...
        rew["rl_0"] = rew_rl_0 + rew_rl_0 * (1-team_0) * fff + ts_rew_0_123 * team_0 * fff 
        rew["rl_1"] = rew_rl_1 + rew_rl_1 * (1-team_1) * fff + ts_rew_1_023 * team_1 * fff
        rew["rl_2"] = rew_rl_2 + rew_rl_2 * (1-team_2) * fff + ts_rew_2_013 * team_2 * fff 
        rew["rl_3"] = rew_rl_3 + rew_rl_3 * (1-team_3) * fff + ts_rew_3_012 * team_3 * fff
