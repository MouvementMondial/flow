...
def visualizer_rllib(args):
    ...
    if not os.path.exists(result_dir+"/results_run_"+args.checkpoint_num+"_"+str(args.teamspirit_0/10.0)+"_"+str(args.teamspirit_1/10.0)):
        os.mkdir(result_dir+"/results_run_"+args.checkpoint_num+"_"+str(args.teamspirit_0/10.0)+"_"+str(args.teamspirit_1/10.0))
    ...
    env_params.additional_params['ap_teamspirit_shuffle'] = False
    env_params.additional_params['ap_teamspirit_0'] = args.teamspirit_0/10.0
    env_params.additional_params['ap_teamspirit_1'] = args.teamspirit_1/10.0
    ...
    # write log file
        ...
        with open(result_dir+"/results_run_"+args.checkpoint_num+"_"+str(args.teamspirit_0/10.0)+"_"+str(args.teamspirit_1/10.0)+"/log_"+str(i)+".csv","w") as f:
            writer = csv.writer(f)
...
def create_parser():
    ...
    parser.add_argument(
        '--teamspirit_0',
        type=float,
        help='Specifies teamspirit of the first vehicle')
    parser.add_argument(
        '--teamspirit_1',
        type=float,
        help='Specifies teamspirit of the second vehicle')    
    return parser
