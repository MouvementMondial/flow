...
def visualizer_rllib(args):
    ...
    if not os.path.exists(result_dir+"/results_run_"+args.checkpoint_num+"_"+str(args.teamspirit_0)+"_"+str(args.teamspirit_1)):
        os.mkdir(result_dir+"/results_run_"+args.checkpoint_num+"_"+str(args.teamspirit_0)+"_"+str(args.teamspirit_1))
    ...
    env_params.additional_params['ap_teamspirit_0'] = args.teamspirit_0
    env_params.additional_params['ap_teamspirit_1'] = args.teamspirit_1 
    ...
    # write log file
        ...
        with open(result_dir+"/results_run_"+args.checkpoint_num+"_"+str(args.teamspirit_0)+"_"+str(args.teamspirit_1)+"/log_"+str(i)+".csv","w") as f:
            writer = csv.writer(f)
